...
export default function Hero() {
  return (
    <header className="max-w-6xl mx-auto px-6 pt-24 pb-16 md:pt-36 md:pb-24 text-center">
      ...
      {/* DEEP DIVE PROOF LINK BUTTON */}
      <div className="mt-8 mb-4">
        <Link 
          href="/proofs" 
          className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-purple-600/10 border border-purple-500/30 text-purple-300 hover:text-white hover:bg-purple-600/20 hover:border-purple-500/60 font-semibold text-sm transition-all"
        >
      ...
      <div className="mt-10 flex flex-wrap justify-center gap-4">
        <a href="https://x.com/0xKhiNG" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-slate-900 border border-slate-800 hover:border-purple-500/50 transition-all">
          <span className="text-sm font-bold text-purple-400 font-mono">𝕏</span>
          <span className="text-sm font-medium">Follow on X</span>
        </a>
        <a href="https://t.me/iam0xKhiNG" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-slate-900 border border-slate-800 hover:border-cyan-500/50 transition-all">
